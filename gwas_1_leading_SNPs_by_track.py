...
def main(directory_gwas_combined_files, directory_gwas_sig_snps, sd):
    ...
    os.makedirs(f"./gwas_1_leading_SNPs_by_track/sd={sd}", exist_ok = True)
    ...
    for file in combined_files:
        ...
        result_df.to_csv(f'./gwas_1_leading_SNPs_by_track/sd={sd}/filtered_snps_gwas_1_track={track_col}_sd={sd}.csv', index=False)
        ...
        overlap_df.to_csv(f'./gwas_1_leading_SNPs_by_track/sd={sd}/filtered_snps_gwas_1_track={track_col}_sd={sd}_overlap_df.csv', index=False)
